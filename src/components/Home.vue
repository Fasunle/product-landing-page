...
<template>
  <div
    class="home mt-12 grid grid-cols-1 sm:grid-cols-2 sm:gap-4 items-center sm:items-start"
  >
    <div class="grid grid-cols-1 md:grid-rows-6">
      <div class="row-span-5 w-full sm:w-5/6 mx-auto mb-6 sm:max-w-sm">
        <img
          class="h-full sm:rounded-xl"
    ...
    <div class="sm:mt-4 max-w-md text-center sm:text-left">
      <p class="uppercase text-orange-400 text-lg my-2 sm:my-4 font-bold">
        Sneaker Company
      </p>

      <h1
        class="capitalize text-black text-3xl mb-4 font-extrabold w-full sm:w-2/3"
      >
      ...
      <div class="flex justify-between sm:flex-col">
        <div class="flex mb-2 justify-center sm:justify-start">
          ...
          <p
            class="text-orange-600 font-bold rounded-md ml-4 px-2 bg-orange-100"
          >
            50%
          </p>
        </div>
